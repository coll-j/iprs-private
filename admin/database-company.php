...
<body>
    ...
    <div class="wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-box">
                        <a href="#create_company" class="btn btn-custom btn-rounded w-md waves-effect waves-light pull-right" data-animation="blur" data-plugin="custommodal" data-overlaySpeed="100" data-overlayColor="#36404a"><i class="mdi mdi-plus"></i> Add Company Type</a>
                        <h4 class="m-t-0 header-title">Company Type List</h4>
                        <p class="text-muted m-b-30 font-13">
                            All the company types of database input.
                        </p>
                        ...
                        <div id="load-company-type"></div> <!-- products will be load here -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myLabel">View Company Type</h4>
                </div>
                <div class="modal-body" id="detail_company"></div>
    ...
    <!-- Modal -->
    <div id="create_company" class="modal-demo">
        <button type="button" class="close" onclick="Custombox.close();">
            <span>&times;</span><span class="sr-only">Close</span>
        </button>
        <h4 class="custom-modal-title">Create Company Type</h4>
        <div class="custom-modal-text">
            <form class="form-horizontal" action="include/process.php" method="post">

                <div class="form-group m-b-25">
                    <div class="col-12">
                        <label for="comp_type">Name</label>
                        <input class="form-control" type="text" id="comp_type" name="name" placeholder="Name of company type" required>
                    </div>
                </div>
                ...
                <input type="hidden" name="action" value="add_company_type">
    ...
    <!-- sample modal content -->
    <div id="edit_company" class="modal fade edit_company" tabindex="-1" role="dialog" aria-labelledby="myLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                <form class="form-horizontal" action="include/process.php" method="post">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        <h4 class="modal-title" id="myLabel">Edit Company Type</h4>
                    </div>
                    <div class="modal-body" id="get_company"></div>
                    <div class="modal-footer">
                        <input type="hidden" name="action" value="edit_company_type">
                        <input type="hidden" name="username" value="<?php echo $_SESSION['username']; ?>">
    ...
    <script type="text/javascript">
        // Read the company type
        $(document).ready(function() {
            readCompany();
        });
        
        // View detail company type using modal
        $(document).ready(function() {
            $(document).on('click', '#getData', function(e) {
                ...
                .done(function(data){
                    console.log(data);  
                    $('#detail_company').html(data); // load response 
                    $('#view_data').modal("show"); 
                })
                .fail(function(){
                    $('#detail_company').html('<div class="alert alert-danger" role="alert">Something wrong, please try again...</div>');
                    $('#view_data').modal("show"); 
                });
            });
        });
        ...
        $(document).ready(function() {
            $(document).on('click', '#editCompany', function(e) {
                ...
                .done(function(data) {
                    console.log(data);
                    $('#get_company').html(data);
                    $('#edit_company').modal('show');
                })
                .fail(function() {
                    $('#get_company').html('<div class="alert alert-danger" role="alert">Something wrong, please try again...</div>');
                    $('#edit_company').modal('show');
                })
            });
        });
            ...
            swal({
                ...
                preConfirm: function() {
                  return new Promise(function(resolve) {
                     ...
                     $.ajax({
                        url: 'database-company-delete.php',
                        type: 'POST',
                        data: 'delete='+id,
                        dataType: 'json'
                     })
        ...
        function readCompany() {
            $('#load-company-type').load('database-company-load.php');   
        }
    </script>
