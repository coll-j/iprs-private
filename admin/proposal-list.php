<?php 
    ...
    $data = get_data("iprs_proposal", "stats, file_size");
    $total_proposal = count($data);
    $total_approved = 0;
    $total_dissaproved = 0;
    $total_size = 0;
    foreach ($data as $row) {
        if($row['stats'] == "approve") $total_approved++;
        if($row['stats'] == "disapprove") $total_dissaproved++;
    ...
    <div class="wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-box">
                        <h4 class="m-t-0 header-title">Proposal List</h4>
                        <p class="text-muted m-b-30 font-13">
                            All the proposals uploaded by user.
                        </p>
                            ...
                            <div class="row">
                                <div class="col-xs-6 col-sm-3">
                                    <div class="card-box widget-flat border-custom bg-custom text-white">
                                        <i class="fi-paper"></i>
                                        <h3 class="m-b-10"><?php echo $total_proposal; ?></h3>
                                        <p class="text-uppercase m-b-5 font-13 font-600">Proposals</p>
                                    </div>
                                </div>
                                <div class="col-xs-6 col-sm-3">
                                    <div class="card-box bg-success widget-flat border-success text-white">
                                        <i class="fi-check"></i>
                                        <h3 class="m-b-10"><?php echo $total_approved; ?></h3>
                                        <p class="text-uppercase m-b-5 font-13 font-600">Proposals Approved</p>
                                    </div>
                                </div>
                                <div class="col-xs-6 col-sm-3">
                                    <div class="card-box widget-flat border-danger bg-danger text-white">
                                        <i class="fi-cross"></i>
                                        <h3 class="m-b-10"><?php echo $total_dissaproved; ?></h3>
                                        <p class="text-uppercase m-b-5 font-13 font-600">Proposals Dissaproved</p>
                                    </div>
                                </div>
                                <div class="col-xs-6 col-sm-3">
                                    <div class="card-box bg-primary widget-flat border-primary text-white">
                                        <i class="fi-cloud"></i>
                                        <h3 class="m-b-10"><?php echo size($total_size); ?></h3>
                                        <p class="text-uppercase m-b-5 font-13 font-600">Total Attachments Size</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="load-proposal"></div> <!-- products will be load here -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myLabel">View Proposal</h4>
                </div>
                <div class="modal-body" id="detail_proposal">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $(document).on('click', '#getData', function(e) {
                ...
                .done(function(data){
                    console.log(data);  
                    $('#detail_proposal').html(data); // load response 
                    $('#view_data').modal("show"); 
                })
                .fail(function(){
                    $('#detail_proposal').html('<div class="alert alert-danger" role="alert">Something wrong, please try again...</div>');
                    $('#view_data').modal("show"); 
                });
            });
        });
        ...
        function readProposal() {
            $('#load-proposal').load('proposal-read.php');   
        }
    </script>
