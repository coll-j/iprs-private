    ...
    <div class="wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-box">
                        <button type="button" class="btn btn-custom btn-rounded w-md waves-effect waves-light pull-right" onclick="location.href='./changelog-list'"><i class="mdi mdi-keyboard-backspace"></i> All Changelogs</button>
                        <h4 class="m-t-0 header-title">Add Changelog</h4>
                        <p class="text-muted m-b-30 font-13">
                            Fill the form below to add a changelog.
                        </p>
                        ...
                        <form class="form-horizontal" role="form" action="include/process.php" method="post" enctype="multipart/form-data" onsubmit="return postForm()">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="version" name="version" placeholder="Enter version here" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="datepicker-autoclose" class="col-form-label">Release Date</label>
                                    <input type="text" class="form-control" placeholder="mm/dd/yyyy" id="datepicker-autoclose" name="date" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-12">
