<?php 
    ...
    if (isset($_REQUEST['id'])) {
        ...
        $data = get_data("iprs_comp_type", "name, active", "id = '$id'");
?>
        ...
        <?php foreach($data as $row) { ?>
            <div class="form-group m-b-25">
                <div class="col-12">
                    ...
                    <input class="form-control" type="text" id="comp_type" name="name" placeholder="Name of company type" value="<?php echo $row['name']; ?>" required>
                </div>
            </div>
