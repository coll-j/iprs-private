<?php 
    ...
    $data = get_data("iprs_comp_type", "*", "", "id ASC");
    $x = 1;
?>
...
<?php if($data) { ?>
    <table class="table table-hover m-0 tickets-list table-actions-bar dt-responsive nowrap" cellspacing="0" width="100%" id="datatable">
        <thead>
            <tr>
                <th width="20px">#</th>
                <th data-toggle="true">Company Type</th>
                <th>Stats</th>
                <th>Created By</th>
                <th>Created Date</th>
            ...
            <?php foreach ($data as $row) { ?>
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" data-toggle="tooltip" data-id="<?php echo $row['id']; ?>" id="editCompany" data-placement="top" class="btn btn-sm btn-custom edit_company" data-target="edit_company" data-original-title="Edit" title="Edit"><i class="mdi mdi-pencil"></i></button>
                        ...
                        <button type="button" id="deleteCompany" data-id="<?php echo $row['id']; ?>" data-toggle="tooltip" data-placement="top" class="btn btn-sm btn-danger" title="Delete" data-original-title="Delete"><i class="mdi mdi-delete"></i></button>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
