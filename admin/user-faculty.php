...
<body>
    ...
    <div class="wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-box">
                        <a href="#create_faculty" class="btn btn-custom btn-rounded w-md waves-effect waves-light pull-right" data-animation="blur" data-plugin="custommodal" data-overlaySpeed="100" data-overlayColor="#36404a"><i class="mdi mdi-plus"></i> Add Faculty</a>
                        <h4 class="m-t-0 header-title">Faculty List</h4>
                        <p class="text-muted m-b-30 font-13">
                            All the faculties of user and database.
                        </p>
                        ...
                        <div id="load-faculty"></div> <!-- products will be load here -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myLabel">View Faculty</h4>
                </div>
                <div class="modal-body" id="detail_faculty"></div>
    ...
    <!-- Modal -->
    <div id="create_faculty" class="modal-demo">
        <button type="button" class="close" onclick="Custombox.close();">
            <span>&times;</span><span class="sr-only">Close</span>
        </button>
        <h4 class="custom-modal-title">Create Faculty</h4>
            ...
            <form class="form-horizontal" action="include/process.php" method="post">
                ...
                <div class="form-group m-b-25">
                    <div class="col-12">
                        ...
                        <input class="form-control" type="text" id="faculty" name="name" placeholder="Name of faculty" required>
                    </div>
                </div>
                ...
                <div class="form-group m-b-25">
                    <div class="col-12">
                        ...
                        <input class="form-control" type="text" id="slug" name="slug" placeholder="Slug name (ex: ftslk, fadp, fti, etc)" required>
                    </div>
                </div>
    ...
    <!-- sample modal content -->
    <div id="edit_faculty" class="modal fade edit_faculty" tabindex="-1" role="dialog" aria-labelledby="myLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                <form class="form-horizontal" action="include/process.php" method="post">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        <h4 class="modal-title" id="myLabel">Edit Faculty</h4>
                    </div>
                    <div class="modal-body" id="get_faculty"></div>
                    <div class="modal-footer">
    ...
    <script type="text/javascript">
        ...
        // View detail faculty using modal
        $(document).ready(function() {
            $(document).on('click', '#getData', function(e) {
                ...
                .done(function(data){
                    console.log(data);  
                    $('#detail_faculty').html(data); // load response 
                    $('#view_data').modal("show"); 
                })
                .fail(function(){
                    $('#detail_faculty').html('<div class="alert alert-danger" role="alert">Something wrong, please try again...</div>');
                    $('#view_data').modal("show"); 
                });
            });
        });
        ...
        $(document).ready(function() {
            $(document).on('click', '#editFaculty', function(e) {
                e.preventDefault();

                var id = $(this).data('id');

                $.ajax({
                    url: 'user-faculty-edit.php',
                    type: 'POST',
                    data: 'id='+id,
                    dataType: 'html'
                })
                .done(function(data) {
                    console.log(data);
                    $('#get_faculty').html(data);
                    $('#edit_faculty').modal('show');
                })
                .fail(function() {
                    $('#get_faculty').html('<div class="alert alert-danger" role="alert">Something wrong, please try again...</div>');
                    $('#edit_faculty').modal('show');
                })
            });
        });
        ...
        function readFaculty() {
            $('#load-faculty').load('user-faculty-load.php');   
        }
    </script>
