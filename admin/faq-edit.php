    ...
    <div class="wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-box">
                        <button type="button" class="btn btn-custom btn-rounded w-md waves-effect waves-light pull-right" onclick="location.href='./faq-list'"><i class="mdi mdi-keyboard-backspace"></i> Back</button>
                        <h4 class="m-t-0 header-title">Edit FAQ</h4>
                        <p class="text-muted m-b-30 font-13">
                            You're now editing <strong><?php echo $question; ?></strong>.
                        </p>
                        ...
                        <form class="form-horizontal" role="form" action="include/process.php" method="post" enctype="multipart/form-data" onsubmit="return postForm()">
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="question" name="question" placeholder="Enter question here" value="<?php echo $question; ?>" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="summernote" class="col-form-label">Answer</label>
                                    <textarea id="summernote" name="answer" class="summernote" required><?php echo $answer; ?></textarea>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-12">
