    ...
    <div class="wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-box">
                        <button type="button" class="btn btn-custom btn-rounded w-md waves-effect waves-light pull-right" onclick="location.href='./changelog-list'"><i class="mdi mdi-keyboard-backspace"></i> Back</button>
                        <h4 class="m-t-0 header-title">Edit Changelog</h4>
                        <p class="text-muted m-b-30 font-13">
                            You're now editing <strong><?php echo $version; ?></strong>.
                        </p>
                        ...
                        <form class="form-horizontal" role="form" action="include/process.php" method="post" enctype="multipart/form-data" onsubmit="return postForm()">
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="title" class="col-form-label">Title</label>
                                    <input type="text" class="form-control" id="title" name="title" placeholder="Enter title here" value="<?php echo $title; ?>" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="version" class="col-form-label">Version</label>
                                    <input type="text" class="form-control" id="version" name="version" placeholder="Enter version here" value="<?php echo $version; ?>" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="datepicker-autoclose" class="col-form-label">Release Date</label>
                                    <input type="text" class="form-control" placeholder="mm/dd/yyyy" id="datepicker-autoclose" name="date" value="<?php echo "$new_date[1]/$new_date[2]/$new_date[0]"; ?>" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <label for="summernote" class="col-form-label">Content</label>
                                    <textarea id="summernote" name="content" class="summernote" required><?php echo $content; ?></textarea>
                                </div>
                            </div>
                            <br>
                            <div class="form-group text-right m-b-0">
                                <input type="hidden" name="action" value="edit_changelog">
