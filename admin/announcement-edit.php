    ...
    <div class="wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-box">
                        <button type="button" class="btn btn-custom btn-rounded w-md waves-effect waves-light pull-right" onclick="location.href='./announcement-list'"><i class="mdi mdi-keyboard-backspace"></i> Back</button>
                        <h4 class="m-t-0 header-title">Edit Announcement</h4>
                        <p class="text-muted m-b-30 font-13">
                            You're now editing <strong><?php echo $title; ?></strong>.
                        </p>
                        ...
                        <form class="form-horizontal" role="form" action="include/process.php" method="post" enctype="multipart/form-data" onsubmit="return postForm()">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea id="summernote" name="content" class="summernote" required><?php echo $text; ?></textarea>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="datepicker-autoclose" class="col-form-label">Expired Date</label>
                                    <input type="text" class="form-control" placeholder="mm/dd/yyyy" id="datepicker-autoclose" name="expired_date" value="<?php echo "$date[1]/$date[2]/$date[0]"; ?>" required>
                                </div>
                                <div class="form-group col-md-6">
