<?php 
    ...
    $data = get_data("iprs_event_type", "*", "", "id ASC");
    $x = 1;
?>
            ...
            <?php foreach ($data as $row) { ?>
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" data-toggle="tooltip" data-id="<?php echo $row['id']; ?>" id="editEvent" data-placement="top" class="btn btn-sm btn-custom edit_event" data-target="edit_event" data-original-title="Edit" title="Edit"><i class="mdi mdi-pencil"></i></button>
                        ...
                        <button type="button" id="deleteEvent" data-id="<?php echo $row['id']; ?>" data-toggle="tooltip" data-placement="top" class="btn btn-sm btn-danger" title="Delete" data-original-title="Delete"><i class="mdi mdi-delete"></i></button>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
