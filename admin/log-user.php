<?php 
    ...
    foreach ($data_log as $row) {
        if($row['slug'] != 'admin' && $row['slug'] != 'login') {
            $total_log++;
...
<body>
    ...
    <div class="wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-box">
                        <h4 class="m-t-0 header-title">User Logs List</h4>
                        <p class="text-muted m-b-30 font-13">
                            All logs by user in <?php echo $system_name; ?>.
                        </p>
   ...
   <!-- Tooltipster js -->
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $(document).on('click', '#deleteLogUser', function(e) {
        ...
        function readUser() {
            $('#load-user').load('log-user-read.php');   
        }
    </script>
