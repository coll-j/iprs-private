<?php 
    ...
    $data = get_data("iprs_faq", "*", "", "id DESC");
    $x = 1;
?>
        ...
        <tbody>
            <?php foreach ($data as $row) { ?>
                <tr>
                    ...
                    <td><?php echo substr($row['answer'], 0, 30); echo "..."; ?></td>
                    ...
                    <td>
                        <div class="btn-group dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <button type="button" onclick="location.href='./faq-edit/<?php echo $row['id']; ?>'" class="dropdown-item" data-toggle="tooltip" data-placement="top" data-original-title="Edit"><i class="mdi mdi-pencil mr-2 text-muted font-18 vertical-middle"></i>Edit</button>
                                <button type="button" class="dropdown-item" id="deleteFAQ" data-id="<?php echo $row['id']; ?>" data-toggle="tooltip" data-placement="top" class="btn btn-sm btn-danger" title="" data-original-title="Delete"><i class="mdi mdi-delete mr-2 text-muted font-18 vertical-middle"></i> Delete</button>
                            </div>
                        </div>
                    </td>
                    <!-- <td>
