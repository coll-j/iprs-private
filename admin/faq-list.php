<?php 
    ...
    $data = get_data("iprs_faq", "*");
    $total_faq = count($data);
?>
    ...
    <div class="wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-box">
                        <button type="button" class="btn btn-custom btn-rounded w-md waves-effect waves-light pull-right" onclick="location.href='./faq-add'"><i class="mdi mdi-plus"></i> Add FAQ</button>
                        <h4 class="m-t-0 header-title">Frequently Asked Questions List</h4>
                        <p class="text-muted m-b-30 font-13">
                            All FAQs in <?php echo $system_name; ?>.
                        </p>
                            ...
                            <div class="row">
                                <div class="col-xs-6 col-sm-4">
                                    <div class="card-box widget-flat border-custom bg-custom text-white">
                                        ...
                                        <h3 class="m-b-10"><?php echo $total_faq; ?></h3>
                                        <p class="text-uppercase m-b-5 font-13 font-600">FAQs</p>
                                    </div>
                                </div>
                                <div class="col-xs-6 col-sm-8 text-left">
                                    <h5>What is FAQs?</h5>
                                    <p><strong>Frequently Asked Question</strong> is a page that give information about frequently asked question from user. Using FAQ, user can easy to understand about <?php echo $system_name; ?>. FAQ will be displayed in user panel. You can add FAQ as you wish but remember just only <strong>active</strong> FAQ will be displayed in user panel.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="load-faq"></div> <!-- products will be load here -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myLabel">View FAQ</h4>
                </div>
                <div class="modal-body" id="detail_faq">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $(document).on('click', '#getData', function(e) {
                ...
                .done(function(data){
                    console.log(data);  
                    $('#detail_faq').html(data); // load response 
                    $('#view_data').modal("show"); 
                })
                .fail(function(){
                    $('#detail_faq').html('<div class="alert alert-danger" role="alert">Something wrong, please try again...</div>');
                    $('#view_data').modal("show"); 
                });
            });
        });
