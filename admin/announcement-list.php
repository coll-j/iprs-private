<?php 
    ...
    $data_announcement = get_data("iprs_announcement", "*");
    $total_announcement = count($data_announcement);
    
    $data_active = get_data("iprs_announcement", "active", "active = 'yes'");
    $total_active = count($data_active);

    $data_unactive = get_data("iprs_announcement", "active", "active = 'no'");
    $total_unactive = count($data_unactive);
?>
...
<body>
    ...
    <div class="wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-box">
                        <button type="button" class="btn btn-custom btn-rounded w-md waves-effect waves-light pull-right" onclick="location.href='./announcement-add'"><i class="mdi mdi-plus"></i> Add Announcement</button>
                        <h4 class="m-t-0 header-title">Announcement List</h4>
                        <p class="text-muted m-b-30 font-13">
                            All announcements in <?php echo $system_name; ?>.
                        </p>
                            ...
                            <div class="row">
                                <div class="col-xs-6 col-sm-4">
                                    <div class="card-box widget-flat border-custom bg-custom text-white">
                                        ...
                                        <h3 class="m-b-10"><?php echo $total_announcement; ?></h3>
                                        <p class="text-uppercase m-b-5 font-13 font-600">Announcements</p>
                                    </div>
                                </div>
                                <div class="col-xs-6 col-sm-4">
                                    <div class="card-box bg-success widget-flat border-success text-white">
                                        <i class="fi-check"></i>
                                        <h3 class="m-b-10"><?php echo $total_active; ?></h3>
                                        <p class="text-uppercase m-b-5 font-13 font-600">Active</p>
                                    </div>
                                </div>
                                <div class="col-xs-6 col-sm-4">
                                    <div class="card-box widget-flat border-danger bg-danger text-white">
                                        <i class="fi-cross"></i>
                                        <h3 class="m-b-10"><?php echo $total_unactive; ?></h3>
                                        <p class="text-uppercase m-b-5 font-13 font-600">Not Active</p>
                                    </div>
                                </div>
                            </div>

                            <div class="col-12 text-left">
                                <h5>What is announcement?</h5>
                                <p><strong>Announcement system</strong> is a feature of IPRS BEM ITS that can be used by administrator to share urgently information to user. Announcement will display in every page of user panel and will be seen until the time you have set before. <strong>Please note,</strong> only active announcement will be displayed! So, if you want to announce some information, you need to activate it and set the time to the specified limit.</p>
                            </div>
                        </div>
                        ...
                        <div id="load-announcement"></div> <!-- products will be load here -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myLabel">View Announcement</h4>
                </div>
                <div class="modal-body" id="detail_announcement">
   ...
   <!-- Tooltipster js -->
    ...
    <script type="text/javascript">
        ...
        // View detail announcement using modal
        $(document).ready(function() {
            $(document).on('click', '#getData', function(e) {
                ...
                .done(function(data){
                    console.log(data);  
                    $('#detail_announcement').html(data); // load response 
                    $('#view_data').modal("show"); 
                })
                .fail(function(){
                    $('#detail_announcement').html('<div class="alert alert-danger" role="alert">Something wrong, please try again...</div>');
                    $('#view_data').modal("show"); 
                });
            });
        });
        ...
        function readAnnouncement() {
            $('#load-announcement').load('announcement-read.php');   
        }
    </script>
