<?php 
    ...
    $data_login = get_data("iprs_log", "slug, stats, ip");
    $total_login = 0;
    $total_success = 0;
    $total_error = 0;
...
<body>
    ...
    <div class="wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-box">
                        <h4 class="m-t-0 header-title">Login History</h4>
                        <p class="text-muted m-b-30 font-13">
                            All login attemp in <?php echo $system_name; ?>.
                        </p>
                            ...
                            <div class="row">
                                <div class="col-xs-6 col-sm-4">
                                    <div class="card-box widget-flat border-custom bg-custom text-white">
                                        ...
                                        <p class="text-uppercase m-b-5 font-13 font-600">Login History</p>
                                    </div>
                                </div>
                                <div class="col-xs-6 col-sm-4">
                                    <div class="card-box bg-success widget-flat border-success text-white">
                                        ...
                                        <p class="text-uppercase m-b-5 font-13 font-600">Login Success</p>
                                    </div>
                                </div>
                                <div class="col-xs-6 col-sm-4">
                                    <div class="card-box widget-flat border-danger bg-danger text-white">
                                        ...
                                        <p class="text-uppercase m-b-5 font-13 font-600">Login Error</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="load-login"></div> <!-- products will be load here -->
   ...
   <!-- Tooltipster js -->
    ...
    <script type="text/javascript">
        // Read the login history
        $(document).ready(function() {
            readLogin();
        });

        $(document).ready(function() {
            $(document).on('click', '#deleteLogin', function(e) {
        ...
        function readLogin() {
            $('#load-login').load('log-login-read.php');   
        }
    </script>
