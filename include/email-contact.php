<?php
    ...
    if(isset($action)) {
        ...
        try {
            ...
            $mail->Subject = '[IPRS BEM ITS] New Message: '.$subject;
            $mail->Body    = '
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" style="font-family: "Helvetica Neue",Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                        <tr style="font-family: "Helvetica Neue",Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                            <td class="content-block" style="font-family: "Helvetica Neue",Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;" valign="top">
                                                You have <strong style="font-family: "Helvetica Neue",Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">new message</strong> awaiting to be reply.
                                            </td>
                                        </tr>
                                        <tr style="font-family: "Helvetica Neue",Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                            <td class="content-block" style="font-family: "Helvetica Neue",Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;" valign="top">
                                                This is the detail information about the new message:
                                                <br><hr>
                                                <strong>From:</strong> '. $username .' ('. $email .')
                                                <br>
                                                <strong>Subject:</strong> '. $subject .'
                                                <br>
                                                <strong>Message:</strong> <br>'. $message .'
                                                <hr><br>
                                                This message was sent from contact page in IPRS BEM ITS. Please reply to the email from sender, do not reply to this email.
                                            </td>
                                        </tr>
                                    </table>
                                </td>
            ...
            $process = $mail->send();
            if($process) {
                $_SESSION['information'] = "Your message sent successfully.";
                log_system($username, "message", "success", "Message sent (Subject: ". $subject);
            }
        } catch (Exception $e) {
            $_SESSION['form_error'] = "Error! Failed to send message.";
            log_system($username, "message", "error", "Error! Failed to send message.");
        }  
    }
