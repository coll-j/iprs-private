                    ...
                    <table width="100%" cellpadding="0" cellspacing="0"
                        ...
                        <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                            <td class="content-block"
                                ...
                                valign="top">
                                You have <strong
                                    style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">new proposal</strong> awaiting to be approved.
                            </td>
                        </tr>
                        <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                            <td class="content-block"
                                ...
                                <br>
                                <strong>Event Desc:</strong> {{ event_desc }}
                                <br>
                                ...
                                <br>
                                <strong>Stakeholder 1:</strong> {{ stakeholder5 }} ({{ relation5 }})
                                <br><br>
                                <strong>Upload By:</strong> {{ uploaded_by }}
                                <br>
                                <strong>Upload Date:</strong> {{ uploaded_date }}
                                <hr><br>
            ...
            <table width="100%"
                ...
                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                    <td class="aligncenter content-block"
                        ...
                        align="center" valign="top">This message sent from IPRS BEM ITS.
                    </td>
                </tr>
            </table>
        </div>
