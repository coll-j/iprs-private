...
<body>
                        ...
                        <div class="col-12">
                            <div class="card-box table-responsive">
                                ...
                                <div class="pull-right">
                                    <button type="button" onclick="location.href='./proposal'" class="btn btn-custom waves-light waves-effect">Add Proposal</button>
                                </div>
                                <p class="text-muted font-14 m-b-30">
                                    In this page, you can view detail list of proposal you have uploaded to us. Also you can check the proposal has been approved or not by our staff.
                                </p>
    ...
    <script type="text/javascript">
        ...
        function readProposal() {
            $('#load-proposal').load('readproposal.php');   
        }
    </script>
